...
| iperf3 -c jhb.speedtest.sggs.network | -R | 10 | ZA \| 🇿🇦 | Johannesburg |

### ASIA
| **COMMAND** | **OPTIONS** | **GB/S** | **COUNTRY** | **SITE** |
|:------------|:-----------:|:--------:|:-----------:|:---------|
| iperf3 -c hkg.speedtest.sggs.network | -R | 10 | HK \| 🇭🇰 | Hong Kong |
...
| iperf3 -c bom.speedtest.sggs.network | -R | 10 | IN \| 🇮🇳 | Mumbai |
...
| iperf3 -c tyo.speedtest.sggs.network | -R | 10 | JP \| 🇯🇵 | Tokyo |
...
| iperf3 -c sel.speedtest.sggs.network | -R | 10 | KR \| 🇰🇷 | Seoul |
| iperf3 -c 91.185.23.98 | -R |  | KZ \| 🇰🇿 | Aktau |
| iperf3 -c iperf.myren.net.my -p 5201-5210 | -R |  | MY \| 🇲🇾 | Kuala Lumpur |
| iperf3 -c sin.speedtest.sggs.network | -R | 10 | SG \| 🇸🇬 | Singapore |
| iperf3 -c pnh.speedtest.sggs.network | -R | 10 | SG \| 🇸🇬 | Singapore |
...
| iperf3 -c tpe.speedtest.sggs.network | -R | 10 | TW \| 🇹🇼 | Taipei |
...
| iperf3 -c fra.speedtest.sggs.network | -R | 10 | DE \| 🇩🇪 | Frankfurt |
...
| iperf3 -c mrs.speedtest.sggs.network | -R | 10 | FR \| 🇫🇷 | Marseille |
| iperf3 -c 138.199.14.66 | -R | 2x10 | FR \| 🇫🇷 | Marseille |
| iperf3 -c par.speedtest.sggs.network | -R | 10 | FR \| 🇫🇷 | Paris |
...
| **COMMAND** | **OPTIONS** | **GB/S** | **COUNTRY** | **SITE** |
|:------------|:-----------:|:--------:|:-----------:|:---------|
| iperf3 -c 167.249.161.130 -p 5205-5207 | -R |  | BR \| 🇧🇷 | Santa Inês |
...
| iperf3 -c mia.speedtest.sggs.network | -R | 10 | US \| 🇺🇸 | Miami |
...
| iperf3 -c nyc.speedtest.sggs.network | -R | 10 | US \| 🇺🇸 | New York City |
...
| iperf3 -c per.speedtest.sggs.network | -R | 10 | AU \| 🇦🇺 | Perth |
...
| iperf3 -c syd.speedtest.sggs.network | -R | 10 | AU \| 🇦🇺 | Sydney |
