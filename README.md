...
| iperf3 -c 102.165.60.112              |     |      | ZA      | Johannesburg |   |
...
| COMMAND                                            | OPT | GB/s | COUNTRY | SITE            |   |
:----------------------------------------------------|-----|------|---------|:----------------|---|
| perf3 -c 128.1.240.146                             | -R  | 1    | BR      | Sao Paolo       |   |
...
| iperf3 -c speedtest-hki.netplaza.fi                  |       |      | FI      | Helsinki          |    |
...
| iperf3 -c speedtest.fiberway.pl                      |       |      | PL      | Kazimierza Wielka |    |
| iperf3 -c speedtest.midiko.pl                        |       |      | PL      | Katowice          |    |
| iperf3 -c 95.95.252.87 -p 5201/5205/5207             |       |      | PT      | Lissabon          |    |
| iperf3 -c 95.95.252.95                               |       |      | PT      | Porto             |    |
| iperf3 -c 23.90.131.2                                | -R    | 1    | RU      | Moscow            |    |
| iperf3 -c 31.148.48.5                                |       |      | RU      | Angarsk           |    |
| iperf3 -c 62.213.110.86                              |       |      | RU      | Moscow            |    |
